...
let-env PROMPT_MULTILINE_INDICATOR = (^/Users/tianyu/.cargo/bin/starship prompt --continuation)
...
let-env PROMPT_COMMAND = {
    ...
    ^/Users/tianyu/.cargo/bin/starship prompt $"--cmd-duration=($env.CMD_DURATION_MS)" $"--status=($env.LAST_EXIT_CODE)" $"--terminal-width=($width)"
}
