...
AllegroCL installation folder. The second folder defines two entry functions to
start the REPL buffer for =alisp= an =mlisp= respectively.
...
(when (fboundp 'fi:common-lisp)
  ;; rainbow
  (add-hook 'fi:common-lisp-mode-hook #'rainbow-delimiters-mode)
  ;; paredit
